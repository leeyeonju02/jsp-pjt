            ...
            <ul class="nav navbar-nav">
              ...
              <c:if test="${loginUser != null }">
                ...
                <li class="dropdown user user-menu">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <img
                      src="/resources/img/${loginUser.imgUrl }"
                      class="user-image"
                      alt="User Image"
                    />
          ...
          <div class="user-panel">
            <c:if test="${loginUser == null }">
              ...
              <div class="pull-left info">
                <a href="#"
                  ><i class="fa fa-circle text-success"></i> Offline</a
                >
              </div>
            </c:if>
            <c:if test="${loginUser != null }">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li>
                  <a href="/board/listCri"
                    ><i class="fa fa-circle-o"></i> Dashboard v1</a
                  >
                </li>
                --%>
                <li>
                  <a href="/board/list.multicampus"
                    ><i class="fa fa-clipboard" aria-hidden="true"></i
                    >전체게시글</a
                  >
                </li>
                <li>
                  <a href="/board/myPage.multicampus?id=${loginUser.id}"
                    ><i class="fa fa-circle-o"></i> 내가 작성한 게시글</a
                  >
                </li>
              </ul>
            </li>
